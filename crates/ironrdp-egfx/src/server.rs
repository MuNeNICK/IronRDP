...
impl GraphicsPipelineServer {
    ...
    fn handle_capabilities_advertise(&mut self, pdu: CapabilitiesAdvertisePdu) {
        ...
        // Note: surface creation is NOT done here.
        // Some clients (iOS) disconnect on any EGFX graphics PDU (CreateSurface etc.)
        // after CapabilitiesConfirm. Surface creation is handled by the application
        // when it's ready to send frames.
    }
